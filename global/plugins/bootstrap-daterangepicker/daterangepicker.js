...
(function(root, factory) {
  ...
  // Finally, as a browser global.
    ...
    var DateRangePicker = function(element, options, cb) {
		...
		if (typeof options.singleTimePicker === 'boolean') {
			this.singleTimePicker = options.singleTimePicker;
			if (this.singleTimePicker) {
        ...
        if (this.singleDatePicker) {
            ...
            //this.container.find('.daterangepicker_input input, .daterangepicker_input i').hide(); // ONLY HIDE CALENDAR ICON NOT CLOCK ICON
			this.container.find('.daterangepicker_input input, .icon-calendar').hide(); // CHANGE BY JACE
            if (!this.timePicker) {
                this.container.find('.ranges').hide();
            }
        }
